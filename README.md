...
```bash
sam local invoke HelloWorldFunction -e events/events.json
```

If the previous command ran successfully you should now be able to see some output on the console
